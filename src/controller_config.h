...
const uint8_t ALT_SW_KEYCODE[] = {HID_KEY_D, HID_KEY_F, HID_KEY_J, HID_KEY_K,
                                  HID_KEY_SPACE, HID_KEY_P, HID_KEY_ENTER, HID_KEY_ESCAPE};
const uint8_t ALT_ENC_KEYCODE[] = {HID_KEY_ARROW_RIGHT, HID_KEY_ARROW_LEFT, HID_KEY_ARROW_DOWN, HID_KEY_ARROW_UP};
